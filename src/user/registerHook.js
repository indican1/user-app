...
const Register = ({ navigation }) => {
    ...
    const step1 = () => (
        <View style={{ flex: 1, marginTop: 30, alignItems: 'center' }}>
            ...
            />
            {
                ...
                <CustomButton title='Proceed' disabled={phoneNo === '' || phoneNo.length < 11 ? true : false} callFunction={() => checkUser()} />
            }
    ...
    const step2 = () => (
        <View style={styles.container}>
            <View style={{ flex: 1, marginTop: 50, alignItems: 'center' }}>
                ...
                {isLoading ? <ActivityIndicator size='large' color={COLORS.themeColor} style={{marginTop: 20}} /> :
                <CustomButton title='Confirm' disabled={code === '' || code.length < 6 ? true : false} callFunction={() => confirmCode()} />}
                <Text style={[styles.title, { fontSize: 10, marginTop: 5, textAlign: 'center' }]}>
    ...
    const step3 = () => (
        <View style={{ flex: 1, marginTop: 30, alignItems: 'center' }}>
            ...
            <CustomButton title='Proceed' disabled={ssNo === '' || ssNo.length < 13 ? true : false} callFunction={() => increamentStep()} />
            <Text style={[styles.title, { fontSize: 10, marginTop: 5, textAlign: 'center' }]}>
                By proceeding you agree to our <Text style={{ color: COLORS.themeColor, fontWeight: 'bold' }}>Terms & Conditions</Text>
            </Text>
        </View>
    ...
    const step5 = () => (
        <View style={styles.container}>
            <View style={{ flex: 1, marginTop: 50, alignItems: 'center' }}>
                ...
                <CustomButton title='Confirm' disabled={pin.length < 6 || confirmPin.length < 6 ? true : false} callFunction={() => {
                    if (pin != confirmPin) {
    ...
    const step6 = () => (
        <View style={styles.container}>
            <View style={{ flex: 1, marginTop: 50, alignItems: 'center' }}>
                ...
                {
                    isLoading ? <ActivityIndicator size='large' color={COLORS.themeColor} style={{marginTop: 20}} /> :
                    <CustomButton title='Confirm' disabled={imageUri === '' ? true : false} callFunction={() => _registerUser()} />
                }
            </View>
        </View>
    )

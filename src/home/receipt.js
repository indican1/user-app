...
import { View, StyleSheet, Image, Text, TouchableOpacity, Modal, Dimensions, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native';
                                    ...
                                    <View style={{ width: '100%', alignItems: 'center', flex: .8 }}>
                                        {
                                            ...
                                            <View style={{marginTop: 15, width: '100%', alignItems: 'center'}}>
                                                <CustomButton title='Proceed' backgroundColor={COLORS.themeColor} titleColor={COLORS.white} disabled={pin.length < 6 ? true : false} callFunction={() => checkPin()} />
                                            </View>
                                        }
                                    </View>
                                </>
...
const styles = StyleSheet.create({
    ...
    btn: { flex: 1, height: 40, borderRadius: 5, backgroundColor: COLORS.white, marginRight: 30, 
    ...
    modalView: {
        ...
        shadowRadius: 2.62, elevation: 10,  alignItems: 'center',  borderTopRightRadius: 30, borderTopLeftRadius: 30
    },
